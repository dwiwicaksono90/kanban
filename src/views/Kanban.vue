                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input v-model="inputTitle" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Task Detail" required>
                        </div>
                        <div class="form-group">
        ...
        return {
            ...
            kolomTask:
                ...
                },
                {
                    name: 'Done',
                    data: [],
                    class1: 'card border-secondary mb-3 mx-auto',
                    class2: 'card-header bg-secondary text-white font-weight-bold'
                }]
        }
    },
    methods: {
